...
def svc():
    s = SearchService()
    s.index([
        {'id': '1', 'type': 'article', 'title': '人工智能发展趋势', 'content': '深度学习和大模型推动AI快速发展', 'tags': ['AI', '科技']},
        {'id': '2', 'type': 'article', 'title': '新能源汽车市场分析', 'content': '电动汽车销量持续增长，市场份额扩大', 'tags': ['汽车', '新能源']},
        {'id': '3', 'type': 'article', 'title': '数字经济政策解读', 'content': '国家出台多项政策支持数字经济发展', 'tags': ['政策', '经济']},
        {'id': '4', 'type': 'alert',   'title': '负面舆情预警',     'content': '检测到大量负面评论，情感分数骤降', 'tags': ['预警']},
        {'id': '5', 'type': 'article', 'title': '绿色发展与碳中和', 'content': '碳排放目标推动绿色能源转型', 'tags': ['环保', '能源']},
    ])
    return s
...
def test_index_add_document(svc):
    svc.index_one({'id': '99', 'type': 'article', 'title': '量子计算突破', 'content': '量子比特实现新突破', 'tags': []})
