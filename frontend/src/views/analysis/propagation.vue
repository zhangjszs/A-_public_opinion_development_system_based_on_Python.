      ...
      <el-col :xs="24" :lg="8">
        <el-card class="info-card">
          ...
          <el-descriptions :column="1" border v-if="summary.path">
            <el-descriptions-item label="原始发布者">{{ summary.path.origin_user }}</el-descriptions-item>
            <el-descriptions-item label="总转发量">{{ summary.path.total_reposts }}</el-descriptions-item>
            <el-descriptions-item label="传播深度">{{ summary.path.total_depth }}</el-descriptions-item>
            <el-descriptions-item label="传播节点数">{{ summary.path.total_nodes }}</el-descriptions-item>
            <el-descriptions-item label="传播速度">{{ summary.path.propagation_speed?.toFixed(2) }} 节点/小时</el-descriptions-item>
          </el-descriptions>
  ...
  .stat-card {
    .stat-content {
      ...
      .stat-icon {
        ...
        &.primary { background: var(--el-color-primary-light-8); color: var(--el-color-primary); }
